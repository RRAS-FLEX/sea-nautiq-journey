        ...
        <section className="border-b border-border bg-gradient-ocean py-14 md:py-18">
          <div className="container mx-auto px-4">
            ...
            <p className="text-primary-foreground/70 max-w-2xl">
              Ask questions about availability, route options, and trip details for {boatName}.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="lg:col-span-2 shadow-card-hover">
              ...
              <CardContent className="space-y-4">
                ...
                <Textarea placeholder="Hi! I'd like to know if this boat is available for a sunset trip next week..." />
            ...
            <Card className="shadow-card h-fit">
              <CardHeader>
                <CardTitle>Other ways to reach owner</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4 text-sm text-muted-foreground">
                ...
                <div className="grid grid-cols-1 gap-3">
                  <Button asChild className="w-full bg-[#25D366] text-white hover:bg-[#25D366]/90">
                    <a href={whatsappLink} target="_blank" rel="noreferrer">WhatsApp Owner</a>
                  </Button>
                  <Button asChild variant="outline" className="w-full border-[#7360F2] text-[#5b4bc4] hover:bg-[#7360F2]/10 hover:text-[#5b4bc4]">
                    <a href={viberLink}>Message on Viber</a>
                  </Button>
                </div>
                <Button asChild variant="outline" className="w-full">
                  <Link to={returnLink}>Back to boat profile</Link>
                </Button>
              </CardContent>
            </Card>
          </div>
